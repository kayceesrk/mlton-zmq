...
(*[  datasort 'a badRight              (* invariant possibly violated at the right child *)
  ...
  *)
  ...
  fun 'a insert (dict, entry as (key,_)) =
    let
  ...
  in
    (*[ new <: int -> 'a rbt ref ]*)
    fun new (_:int) = ref (Empty : 'a dict) (* ignore size spec *)
