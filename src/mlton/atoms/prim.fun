...
fun 'a checkApp (prim: 'a t,
  ...
  in
      case prim of
       ...
       | MLton_deserializeZMQMsg => oneTarg (fn t => (oneArg (word (WordSize.cpointer ())), t))
       ...
       | MLton_ZMQ_Send => oneTarg (fn t => (fourArgs (t, word8Vector, word (WordSize.cpointer ()), cint), cint))
