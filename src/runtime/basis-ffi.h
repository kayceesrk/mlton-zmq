...
PRIVATE extern const C_Int_t MLton_ZMQ_AFFINITY;
PRIVATE extern const C_Int_t MLton_ZMQ_BACKLOG;
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_bind(C_ZMQ_Socket_t,NullString8_t);
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_close(C_ZMQ_Socket_t);
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_connect(C_ZMQ_Socket_t,NullString8_t);
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_ctx_destroy(C_ZMQ_Context_t);
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_ctx_get(C_ZMQ_Context_t,C_Int_t);
PRIVATE C_Errno_t(C_ZMQ_Context_t) MLton_ZMQ_ctx_new(void);
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_ctx_set(C_ZMQ_Context_t,C_Int_t,C_Int_t);
PRIVATE extern const C_Int_t MLton_ZMQ_DEALER;
PRIVATE extern const C_Int_t MLton_ZMQ_DELAY_ATTACH_ON_CONNECT;
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_disconnect(C_ZMQ_Socket_t,NullString8_t);
PRIVATE extern const C_Int_t MLton_ZMQ_DONTWAIT;
PRIVATE extern const C_Int_t MLton_ZMQ_EVENTS;
PRIVATE extern const C_Int_t MLton_ZMQ_FD;
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_getSockOpt(C_ZMQ_Socket_t,C_Int_t,Array(Word8_t),Ref(C_Size_t));
PRIVATE extern const C_Int_t MLton_ZMQ_IDENTITY;
PRIVATE extern const C_Int_t MLton_ZMQ_IO_THREADS;
PRIVATE extern const C_Int_t MLton_ZMQ_IPV4ONLY;
PRIVATE extern const C_Int_t MLton_ZMQ_LAST_ENDPOINT;
PRIVATE extern const C_Int_t MLton_ZMQ_LINGER;
PRIVATE extern const C_Int_t MLton_ZMQ_MAX_SOCKETS;
...
PRIVATE extern const C_Int_t MLton_ZMQ_RATE;
PRIVATE extern const C_Int_t MLton_ZMQ_RCVBUF;
PRIVATE extern const C_Int_t MLton_ZMQ_RCVHWM;
PRIVATE extern const C_Int_t MLton_ZMQ_RCVMORE;
PRIVATE extern const C_Int_t MLton_ZMQ_RCVTIMEO;
PRIVATE extern const C_Int_t MLton_ZMQ_RECONNECT_IVL;
PRIVATE extern const C_Int_t MLton_ZMQ_RECONNECT_IVL_MAX;
PRIVATE extern const C_Int_t MLton_ZMQ_RECOVERY_IVL;
PRIVATE C_Errno_t(C_ZMQ_Message_t) MLton_ZMQ_recv(C_ZMQ_Socket_t,C_Int_t);
PRIVATE extern const C_Int_t MLton_ZMQ_REP;
PRIVATE extern const C_Int_t MLton_ZMQ_REQ;
PRIVATE extern const C_Int_t MLton_ZMQ_ROUTER;
PRIVATE extern const C_Int_t MLton_ZMQ_ROUTER_MANDATORY;
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_setSockOpt(C_ZMQ_Socket_t,C_Int_t,Vector(Word8_t),C_Size_t);
PRIVATE extern const C_Int_t MLton_ZMQ_SNDBUF;
PRIVATE extern const C_Int_t MLton_ZMQ_SNDHWM;
PRIVATE extern const C_Int_t MLton_ZMQ_SNDMORE;
PRIVATE extern const C_Int_t MLton_ZMQ_SNDTIMEO;
PRIVATE C_Errno_t(C_ZMQ_Socket_t) MLton_ZMQ_socket(C_ZMQ_Context_t,C_Int_t);
PRIVATE extern const C_Int_t MLton_ZMQ_SUB;
PRIVATE extern const C_Int_t MLton_ZMQ_SUBSCRIBE;
PRIVATE extern const C_Int_t MLton_ZMQ_TCP_ACCEPT_FILTER;
PRIVATE extern const C_Int_t MLton_ZMQ_TCP_KEEPALIVE;
PRIVATE extern const C_Int_t MLton_ZMQ_TCP_KEEPALIVE_CNT;
PRIVATE extern const C_Int_t MLton_ZMQ_TCP_KEEPALIVE_IDLE;
PRIVATE extern const C_Int_t MLton_ZMQ_TCP_KEEPALIVE_INTVL;
PRIVATE extern const C_Int_t MLton_ZMQ_TYPE;
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_unbind(C_ZMQ_Socket_t,NullString8_t);
PRIVATE extern const C_Int_t MLton_ZMQ_UNSUBSCRIBE;
PRIVATE extern const C_Int_t MLton_ZMQ_XPUB;
PRIVATE extern const C_Int_t MLton_ZMQ_XPUB_VERBOSE;
PRIVATE extern const C_Int_t MLton_ZMQ_XSUB;
