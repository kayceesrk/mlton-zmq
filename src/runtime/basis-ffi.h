...
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_bind(C_Pointer_t,NullString8_t);
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_close(C_Pointer_t);
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_connect(C_Pointer_t,NullString8_t);
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_ctx_destroy(C_Pointer_t);
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_ctx_get(C_Pointer_t,C_Int_t);
PRIVATE C_Errno_t(C_Pointer_t) MLton_ZMQ_ctx_new(void);
PRIVATE C_Errno_t(C_Int_t) MLton_ZMQ_ctx_set(C_Pointer_t,C_Int_t,C_Int_t);
...
PRIVATE C_Errno_t(C_Pointer_t) MLton_ZMQ_socket(C_Pointer_t,C_Int_t);
