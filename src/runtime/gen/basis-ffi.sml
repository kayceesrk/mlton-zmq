...
structure ZMQ =
struct
val bind = _import "MLton_ZMQ_bind" private : C_Pointer.t * NullString8.t -> (C_Int.t) C_Errno.t;
val close = _import "MLton_ZMQ_close" private : C_Pointer.t -> (C_Int.t) C_Errno.t;
val connect = _import "MLton_ZMQ_connect" private : C_Pointer.t * NullString8.t -> (C_Int.t) C_Errno.t;
val ctx_destroy = _import "MLton_ZMQ_ctx_destroy" private : C_Pointer.t -> (C_Int.t) C_Errno.t;
val ctx_get = _import "MLton_ZMQ_ctx_get" private : C_Pointer.t * C_Int.t -> (C_Int.t) C_Errno.t;
val ctx_new = _import "MLton_ZMQ_ctx_new" private : unit -> (C_Pointer.t) C_Errno.t;
val ctx_set = _import "MLton_ZMQ_ctx_set" private : C_Pointer.t * C_Int.t * C_Int.t -> (C_Int.t) C_Errno.t;
...
val socket = _import "MLton_ZMQ_socket" private : C_Pointer.t * C_Int.t -> (C_Pointer.t) C_Errno.t;
