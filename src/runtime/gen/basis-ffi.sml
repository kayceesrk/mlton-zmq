...
structure ZMQ = 
struct
val AFFINITY = _const "MLton_ZMQ_AFFINITY" : C_Int.t;
val BACKLOG = _const "MLton_ZMQ_BACKLOG" : C_Int.t;
val bind = _import "MLton_ZMQ_bind" private : C_ZMQ_Socket.t * NullString8.t -> (C_Int.t) C_Errno.t;
val close = _import "MLton_ZMQ_close" private : C_ZMQ_Socket.t -> (C_Int.t) C_Errno.t;
val connect = _import "MLton_ZMQ_connect" private : C_ZMQ_Socket.t * NullString8.t -> (C_Int.t) C_Errno.t;
val ctx_destroy = _import "MLton_ZMQ_ctx_destroy" private : C_ZMQ_Context.t -> (C_Int.t) C_Errno.t;
val ctx_get = _import "MLton_ZMQ_ctx_get" private : C_ZMQ_Context.t * C_Int.t -> (C_Int.t) C_Errno.t;
val ctx_new = _import "MLton_ZMQ_ctx_new" private : unit -> (C_ZMQ_Context.t) C_Errno.t;
val ctx_set = _import "MLton_ZMQ_ctx_set" private : C_ZMQ_Context.t * C_Int.t * C_Int.t -> (C_Int.t) C_Errno.t;
val DEALER = _const "MLton_ZMQ_DEALER" : C_Int.t;
val DELAY_ATTACH_ON_CONNECT = _const "MLton_ZMQ_DELAY_ATTACH_ON_CONNECT" : C_Int.t;
val disconnect = _import "MLton_ZMQ_disconnect" private : C_ZMQ_Socket.t * NullString8.t -> (C_Int.t) C_Errno.t;
val DONTWAIT = _const "MLton_ZMQ_DONTWAIT" : C_Int.t;
val EVENTS = _const "MLton_ZMQ_EVENTS" : C_Int.t;
val FD = _const "MLton_ZMQ_FD" : C_Int.t;
val getSockOpt = _import "MLton_ZMQ_getSockOpt" private : C_ZMQ_Socket.t * C_Int.t * (Word8.t) array * (C_Size.t) ref -> (C_Int.t) C_Errno.t;
val IDENTITY = _const "MLton_ZMQ_IDENTITY" : C_Int.t;
val IO_THREADS = _const "MLton_ZMQ_IO_THREADS" : C_Int.t;
val IPV4ONLY = _const "MLton_ZMQ_IPV4ONLY" : C_Int.t;
val LAST_ENDPOINT = _const "MLton_ZMQ_LAST_ENDPOINT" : C_Int.t;
val LINGER = _const "MLton_ZMQ_LINGER" : C_Int.t;
val MAX_SOCKETS = _const "MLton_ZMQ_MAX_SOCKETS" : C_Int.t;
...
val RATE = _const "MLton_ZMQ_RATE" : C_Int.t;
val RCVBUF = _const "MLton_ZMQ_RCVBUF" : C_Int.t;
val RCVHWM = _const "MLton_ZMQ_RCVHWM" : C_Int.t;
val RCVMORE = _const "MLton_ZMQ_RCVMORE" : C_Int.t;
val RCVTIMEO = _const "MLton_ZMQ_RCVTIMEO" : C_Int.t;
val RECONNECT_IVL = _const "MLton_ZMQ_RECONNECT_IVL" : C_Int.t;
val RECONNECT_IVL_MAX = _const "MLton_ZMQ_RECONNECT_IVL_MAX" : C_Int.t;
val RECOVERY_IVL = _const "MLton_ZMQ_RECOVERY_IVL" : C_Int.t;
val recv = _import "MLton_ZMQ_recv" private : C_ZMQ_Socket.t * C_Int.t -> (C_ZMQ_Message.t) C_Errno.t;
val REP = _const "MLton_ZMQ_REP" : C_Int.t;
val REQ = _const "MLton_ZMQ_REQ" : C_Int.t;
val ROUTER = _const "MLton_ZMQ_ROUTER" : C_Int.t;
val ROUTER_MANDATORY = _const "MLton_ZMQ_ROUTER_MANDATORY" : C_Int.t;
val setSockOpt = _import "MLton_ZMQ_setSockOpt" private : C_ZMQ_Socket.t * C_Int.t * (Word8.t) vector * C_Size.t -> (C_Int.t) C_Errno.t;
val SNDBUF = _const "MLton_ZMQ_SNDBUF" : C_Int.t;
val SNDHWM = _const "MLton_ZMQ_SNDHWM" : C_Int.t;
val SNDMORE = _const "MLton_ZMQ_SNDMORE" : C_Int.t;
val SNDTIMEO = _const "MLton_ZMQ_SNDTIMEO" : C_Int.t;
val socket = _import "MLton_ZMQ_socket" private : C_ZMQ_Context.t * C_Int.t -> (C_ZMQ_Socket.t) C_Errno.t;
val SUB = _const "MLton_ZMQ_SUB" : C_Int.t;
val SUBSCRIBE = _const "MLton_ZMQ_SUBSCRIBE" : C_Int.t;
val TCP_ACCEPT_FILTER = _const "MLton_ZMQ_TCP_ACCEPT_FILTER" : C_Int.t;
val TCP_KEEPALIVE = _const "MLton_ZMQ_TCP_KEEPALIVE" : C_Int.t;
val TCP_KEEPALIVE_CNT = _const "MLton_ZMQ_TCP_KEEPALIVE_CNT" : C_Int.t;
val TCP_KEEPALIVE_IDLE = _const "MLton_ZMQ_TCP_KEEPALIVE_IDLE" : C_Int.t;
val TCP_KEEPALIVE_INTVL = _const "MLton_ZMQ_TCP_KEEPALIVE_INTVL" : C_Int.t;
val TYPE = _const "MLton_ZMQ_TYPE" : C_Int.t;
val unbind = _import "MLton_ZMQ_unbind" private : C_ZMQ_Socket.t * NullString8.t -> (C_Int.t) C_Errno.t;
val UNSUBSCRIBE = _const "MLton_ZMQ_UNSUBSCRIBE" : C_Int.t;
val XPUB = _const "MLton_ZMQ_XPUB" : C_Int.t;
val XPUB_VERBOSE = _const "MLton_ZMQ_XPUB_VERBOSE" : C_Int.t;
val XSUB = _const "MLton_ZMQ_XSUB" : C_Int.t;
end
end
structure Net = 
struct
